...
public class App {
    public static void main(String[] args) {
        ...
        // Implementación 1
        Caja<String> cajaTexto = new Caja<>("Hola Sebastian");
        ...
        Par<Integer, String> estudiante = new Par<>(1, "Sebastian Muñoz");
        ...
        System.out.println("Clave: " + estudiante.getClave() +
                " | Valor: " + estudiante.getValor());

        System.out.println("Clave: " + edad.getClave() +
                " | Valor: " + edad.getValor());

        System.out.println("Clave: " + promedio.getClave() +
                " | Valor: " + promedio.getValor());
    }
}